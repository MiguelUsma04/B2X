...
# Rutas accesibles sin sesión. Además de estas, todo lo que cuelga de /t/ y
# de /u/: el rastreo y la baja los abre quien recibe el correo, que nunca va a
# tener sesión acá.
...
async def auth_middleware(request: Request, call_next):
    ...
    if path in PUBLIC_PATHS or path.startswith("/static/") \
            or path.startswith("/t/") or path.startswith("/u/"):
        return await call_next(request)
