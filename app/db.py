...
_NEW_COLUMNS = [
    ...
    ("rating_count", "INTEGER"),
    ("maps_url", "TEXT"),
    # Si el correo volvió porque esa dirección no existe. Va aparte de
    # email_status a propósito: "rebotó" y "está verificado" son dos preguntas
    # distintas, y meterlas en el mismo campo obligaba a rehacer la tabla para
    # agregar un valor — que es exactamente lo que rompió la app el 25/09.
    ("rebotado", "INTEGER NOT NULL DEFAULT 0"),
    ("category", "TEXT"),
    ("social_url", "TEXT"),
    ("ai_profile", "TEXT"),
    ("ai_summary", "TEXT"),
